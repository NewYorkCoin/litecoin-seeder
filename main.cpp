...
public:
  ...
  CDnsSeedOpts() : nThreads(24), nDnsThreads(4), nPort(53), mbox(NULL), ns(NULL), host(NULL), tor(NULL), fUseTestNet(false), fWipeBan(false), fWipeIgnore(false) {}

  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Newyorkc-seeder\n"
...
static const string mainnet_seeds[] = {"192.241.161.74", "84.104.143.203", "198.200.75.246", "148.251.22.48", "90.188.15.233", "88.163.58.182", "37.26.132.126", "91.67.71.142", "98.126.255.243", "176.9.19.119", "144.76.107.81",
	"seed.newyorkco.in", "seed.ds.newyorkco.in", ""};
static const string testnet_seeds[] = {"seed.newyorkco.in", ""};
